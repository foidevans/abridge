/**
 * Score a DOM element based on how likely it is to contain
...
/**
 * Walk the DOM, score block elements, return the best candidate's text.
 * @returns {string}
 */
 ...
 * - Cap at 8000 chars (~2000 tokens) so Gemini doesn't choke
 * @param {string} text
 * @returns {string}
 */
